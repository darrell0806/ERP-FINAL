<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
        <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_edit_petty_cash_b')?>" method="post">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <input disabled type="text" id="nama_bayar" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="nama_bayar" required="required" placeholder="Student Name" value="<?= $duar->nama_bayar?>">
          </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <select disabled id="pembayar_per" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="pembayar_per" required="required">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <select disabled id="jenis_transaksi" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="jenis_transaksi" required="required">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <select disabled id="mata_uang" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="mata_uang" required="required">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <input disabled type="text" id="nominal" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="nominal" required="required" placeholder="Enter the nominal according to what has been made!!" value="<?= $duar->nominal?>">
          </div>
        </div>
        <div class="item form-group">
          <label class="control-label col-12" >Approval By The Treasurer<span class="required"></span>
          </label>
          <div class="col-12">
            <select id="persetujuan_uk" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="persetujuan_uk" required="required">
              <option value="<?= $duar->persetujuan_uk?>"><?= $duar->persetujuan_uk; ?></option>
