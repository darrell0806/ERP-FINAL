<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
        <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_edit_expenditure_k')?>" method="post">
        <input type="hidden" name="id" value="<?= $duar->id_pengeluaran ?>">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <input disabled type="text" id="nominal" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="nominal" required="required" placeholder="Nominal" value="<?= $duar->nominal?>">
          </div>
        </div>
         <div class="item form-group">
          ...
          <div class="col-12">
            <input disabled type="text" id="remark_p" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="remark_p" required="required" placeholder="Remark" value="<?= $duar->remark_p?>">
          </div>
        </div>
        <div class="item form-group">
          <label class="control-label col-12" >Approval By Class Leader <span class="required"></span>
          </label>
          <div class="col-12">
            <select id="persetujuan_k" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="persetujuan_k" required="required">
              <option value="<?= $duar->persetujuan_k?>"><?= $duar->persetujuan_k; ?></option>
