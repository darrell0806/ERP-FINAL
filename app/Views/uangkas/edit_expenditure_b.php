  ...
  <div class="x_panel">
    ...
    <div class="x_content">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="nominal" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="nominal" required="required" placeholder="Nominal" value="<?= $duar->nominal?>">
          </div>
        </div>
         <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="remark_p" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="remark_p" required="required" placeholder="Remark" value="<?= $duar->remark_p?>">
          </div>
        </div>
        <div class="item form-group">
          ...
          <div class="col-12">
            <select id="persetujuan_b" class="form-control col-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="persetujuan_b" required="required">
              <option value="<?= $duar->persetujuan_b?>"><?= $duar->persetujuan_b; ?></option>
