...
<head>
	...
	<base href="<?php echo base_url('/@public_uang/assets') ?>/">

	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="images/ph.png">
	<link href="/@public_uang/assets/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="/@public_uang/assets/vendor/chartist/css/chartist.min.css">
	<link href="/@public_uang/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/@public_uang/assets/css/style.css" rel="stylesheet">
	<link href="../../cdn.lineicons.com/2.0/LineIcons.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="/@public_uang/assets/css/styles.css">
</head>
	...
	<div id="main-wrapper">
		...
		***********************************-->
		<div class="nav-header">
			<a class="brand-logo" href="<?= base_url('uangkas/home/dashboard') ?>">
				<img class="logo-abbr" src="images/ph.png" alt="">
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
									...
									<?php if ($foto->foto != '' && file_exists("@public_uang/assets/images/profile/" . $foto->foto)) { ?>
										<img src="<?= base_url('@public_uang/assets/images/profile/' . $foto->foto) ?>"
											width="20" alt="" />
									<?php } else { ?>
										<img src="<?= base_url('@public_uang/assets/images/profile/default-profile-photo.jpg') ?>"
											width="20" alt="" />
									<?php } ?>
								</a>
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a href="<?= base_url('/landinpage/Home/dashboard') ?>" class="dropdown-item ai-icon">
