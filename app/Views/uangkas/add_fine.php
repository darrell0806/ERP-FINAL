<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
      <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_add_fine')?>" method="post">

         <div class="item form-group">
          <label class="control-label col-md-12 col-sm-12 col-xs-12">Student Name<span class="required"></span>
          </label>
          <div class="col-md-12 col-sm-12 col-xs-12">
            <input id="nama_denda" class="form-control col-md-12 col-xs-12 text-capitalize" data-validate-length-range="6" data-validate-words="2" name="nama_denda" placeholder="Student Name" required="required" type="text">
          </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
          <label class="control-label col-md-12 col-sm-12 col-xs-12">Nominal Fine<span class="required"></span>
          </label>
          <div class="col-md-12 col-sm-12 col-xs-12">
            <input type="text" id="denda" name="denda" placeholder="Nominal Fine" required="required" class="form-control col-md-12 col-xs-12 text-capitalize">
          </div>
        </div> 
        <!-- <div class="item form-group">
        ...
        <!-- <div class="item form-group">
         ...
         <div class="item form-group">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <input type="text" id="nominal" name="nominal" placeholder="Enter the nominal according to the nominal fine!!" required="required" class="form-control col-md-12 col-xs-12 text-capitalize">
          </div>
        </div> -->
         <div class="item form-group">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <input type="text" id="remark_denda" name="remark_denda" placeholder="Remark" required="required" class="form-control col-md-12 col-xs-12 text-capitalize">
          </div>
        </div>
      </div>
