              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-content">
                    <div class="card-body">
                    <form class="form-horizontal form-label-left" novalidate action="<?= base_url('uangkas/Transaksi/aksi_tambah_pembayaran')?>" method="post" enctype="multipart/form-data">
                        <div class="row">
