        ...
        <div class="page-heading">
          ...
          <section class="section">
            <div class="card">
              ...
              <a href="<?=base_url('/uangkas/Transaksi/tambah_pembayaran/')?>" style="position: absolute; top: 10px; right: 10px;">
                    ...
                    <?php 
                                ...
                                foreach ($a as $b) {
                                    ...
                                    <tr>
                                        ...
                                        <a href="#" onclick="showConfirmation('<?php echo base_url('/uangkas/Transaksi/delete_pembayaran/'.$b->id_pembayaran); ?>')">
                                            ...
                                            function showConfirmation(deleteUrl) {
                                              ...
                                              var result = confirm("Apakah Anda yakin data ini akan dihapus?");
                    ...
                    <?php 
                                ...
                                foreach ($a as $b) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $b->deadline?> </td>                                      
                                        <td>
                                        <a href="<?=base_url('/uangkas/Transaksi/edit_pembayaran/'.$b->id_pembayaran)?>"><button class="btn btn-primary">Edit</button></a>    
                                        <a href="#" onclick="showConfirmation('<?php echo base_url('/uangkas/Transaksi/delete_pembayaran/'.$b->id_pembayaran); ?>')">
                                              <button class="btn btn-danger">Delete</button>
                                            </a>
